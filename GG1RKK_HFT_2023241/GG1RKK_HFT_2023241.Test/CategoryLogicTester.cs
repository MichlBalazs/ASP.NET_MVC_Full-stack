    ...
    public class CategoryLogicTester
    {
        ...
        private ICollection<Item> GeneratedItems()
        {
            List<Item> list = new List<Item>
            {
                ...
                new Item {ItemId = 3, ItemName = "WAND", CategoryId = 1, Price = 60 }
                //new Item {ItemId = 4, ItemName = "CHLORANTHY RING", CategoryId = 3, Price = 90 },
                //new Item {ItemId = 5, ItemName = "CROWN OF DUSK", CategoryId = 3, Price = 120 }
            };
            return list;
        }

        [TestCase("test1",3)]
        public void GetItemsNumberInCategoryTester(string cname, int expected)
        {
            //arrange
